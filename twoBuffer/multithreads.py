...
#from generateLabelFuncSingleT import labelFunc
...
if __name__=='__main__':
    ...
    theta1_min = [0]
    theta1_max = [0.5]
    randomTheta1 = np.random.uniform(0,0.5,[500,12])
    randomThetaStack=randomTheta1
    ...
    sheetName='mine_dynamic_opt_twobuffer_thetaAndFlag_500_b37.txt' # generate training data
